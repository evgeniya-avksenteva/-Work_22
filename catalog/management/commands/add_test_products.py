...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        category1 = Category.objects.create(
            name="Напольные покрытия", description="Напольные покрытия для дома"
        )
        category2 = Category.objects.create(name="Электроника", description="")
        category3 = Category.objects.create(name="Книги", description="")
